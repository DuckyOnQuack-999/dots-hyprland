...
QtObject {
    ...
    readonly property var sourceConfig: Config.getSourceConfig("danbooru")
    ...
    // Danbooru API endpoints
    readonly property string baseUrl: "https://danbooru.donmai.us"
    readonly property string apiEndpoint: baseUrl + "/posts.json"
    ...
    function ensureWallpaperTags(wallpaperId) {
        ...
        var url = baseUrl + "/posts/" + wallpaperId + ".json"
        if (apiKey && apiKey.length > 0) {
