...
QtObject {
    ...
    // Konachan configuration
    readonly property var sourceConfig: Config.getSourceConfig("konachan")
    ...
    readonly property bool useSafe: sourceConfig.useSafe || false
    ...
    // Konachan API endpoints
    readonly property string baseUrl: "https://konachan.com"
    readonly property string apiEndpoint: baseUrl + "/post.json"
