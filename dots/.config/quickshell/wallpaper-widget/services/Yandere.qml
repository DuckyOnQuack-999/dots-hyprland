...
QtObject {
    ...
    // Yande.re configuration
    readonly property var sourceConfig: Config.getSourceConfig("yandere")
    ...
    // Yande.re API endpoints
    readonly property string baseUrl: "https://yande.re"
    readonly property string apiEndpoint: baseUrl + "/post/index.json"
    ...
    function ensureWallpaperTags(wallpaperId) {
        ...
        var url = baseUrl + "/post/show/" + wallpaperId + ".json"
