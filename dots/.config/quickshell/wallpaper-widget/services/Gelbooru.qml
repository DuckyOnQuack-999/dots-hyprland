...
QtObject {
    ...
    readonly property var sourceConfig: Config.getSourceConfig("gelbooru")
    ...
    readonly property string baseUrl: "https://gelbooru.com"
    readonly property string apiEndpoint: baseUrl + "/index.php?page=dapi&s=post&q=index&json=1"
